...
def read_sensors():
 try:
    ...
    if ser.in_waiting > 0:
        ...
        tt = 50
        tg = 30
        h = float(humidity) # h = int (random.uniform(5, 100))# h = int(humidity)
        t = float(temperature)# t = int (random.uniform(20, 200))# t = int(temperature)
        g = float(gasValue)# g = int (random.uniform(5, 1000))# g = int(gasValue)
